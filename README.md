...
To divide my VCF into single chromosome VCFs I ran a custom bash script [chr_vcf_split.sh](https://github.com/luciamayorf/Phasing_and_imputation/tree/main/phasing). The chromosomes I decided to keep are the larger ones: 18 autosomes and the X and Y chromosomes.
